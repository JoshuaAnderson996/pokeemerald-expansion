...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_DRAGONIZER = 311,
    ABILITY_CHITTERING_CHORUS = 312,
    ABILITY_EVAPORATE = 313,
    ABILITY_KINETIC_BARRIER = 314,
    ABILITY_KICK_MASTER = 315,
    ABILITY_THE_WAY_OF_AURA = 316,
    ABILITY_ARCANE_POWER = 317,
    ABILITY_AQUA_GODDESS = 318,
    ABILITY_DESERT_TYRANT = 319,
    ABILITY_SHINOBI = 320,
    ABILITY_LUCHADOR = 321,
    ABILITY_BUBBLE_BRAWL = 322,
    ABILITY_MEGA_MIND = 323,
    ABILITY_SEA_GUARDIAN = 324,
    ABILITY_AMOURED_SHELL = 325,
    ABILITY_HEROICS = 326,
    ABILITY_RUFFIAN = 327,
    ABILITY_SPACE_AGE = 328,
    ABILITY_BRAVADO = 329,
    ABILITY_EXORCIST = 330,
    ABILITY_VERDANT_FURY = 331,
    ABILITY_OVERCHARGED = 332,
    ABILITY_WAVE_RIDER = 333,
    ABILITY_SUB_ZERO = 334,
    ABILITY_TECTONIC_BLOOM = 335,
    ABILITY_BLAZING_SUPREMACY = 336,
    ABILITY_SIEGE_SPECIALIST = 337,
    ABILITY_HEROS_LAST_STAND = 338,
    ABILITY_POISON_SPECIALIST = 339,
    ABILITY_SHELLSPLINTER = 340,
    ABILITY_FROST_MONARCH = 341,
    ABILITY_STORM_HERALD = 342,
    ABILITY_HUNTER = 343,
    ABILITY_NO_ESCAPE = 344,
    ABILITY_SOLARIS = 345,
    ABILITY_LUNAR = 346,
    ABILITY_CHEF = 347,
    ABILITY_HAMMER_BRO = 348,
    ABILITY_TIME_LORD = 349,
    ABILITY_EXPLORER = 350,
    ABILITY_WEATHER_WARRIOR = 351,
    ABILITY_DRAGONS_PRIDE = 352,
    ABILITY_MEDIC = 353,
    ABILITY_CLERIC = 354,
    ABILITY_LIGHT_BEARER = 355,
    ABILITY_SOLAR_PRAYER = 356,
    ABILITY_QUICK_TEMPERED = 357,
    ABILITY_MUDDY_BRAWLER = 359,
    ABILITY_STRIKER = 360,
    ABILITY_FORTIFY = 361,
    ABILITY_DRACOGNITION = 362,
    ABILITY_DRACONIC_MIND = 363,
    ABILITY_MEGA_DRACOGNITION = 364,
    ABILITY_MEGA_DRACONIC_MIND = 365,
    ABILITY_GIFT_OF_EMOTION = 366, // Not working yet custom ability for mesprit
    ABILITY_GIFT_OF_KNOWLEDGE = 367, // Not working yet custom ability for uxie
    ABILITY_GIFT_OF_WILLPOWER = 368, // Not working yet custom ability for azelf
    ABILITY_UNDERWORLD_RULER = 369,
    ABILITY_SINGER = 370,
    ABILITY_TOXIC_BLOOM = 371,
    ABILITY_COSMIC_ALLOY = 372,
    ABILITY_JUNGLE_BEAT = 373,
    ABILITY_FLURRY_FEET = 374,
    ABILITY_MUSIC_MAESTRO = 375,
    ABILITY_HITMAN = 376,
    ABILITY_REFRACTORY_METAL = 377,
    ABILITY_CALAMITY_EDGE = 378,
    ABILITY_CURSED_METAL = 379,
    ABILITY_DRAGON_FORCE = 380,
    ABILITY_ULTRA_LAUNCHER = 381,
    ABILITY_IRIDESCENT_EYES = 382,
    ABILITY_FOCUSED_ASSAULT = 383,
    ABILITY_UNERRING_FORCE = 384,
    ABILITY_QUEENS_SUPREMACY = 385,
    ABILITY_KINGS_MIGHT = 386,
    ABILITY_CEREBRAL_SANCTUARY = 387,
    ABILITY_DRACONIC_FLARE = 388,
    ABILITY_PHANTOM_ONSLAUGHT = 389,
    ABILITY_PHANTOM_AEGIS = 390,
    ABILITY_MOTHERS_BOND = 391,
    ABILITY_SUPER_TECHNICIAN = 392,
    ABILITY_AERIAL_DOMINANCE = 393,
    ABILITY_TIDAL_TERROR = 394,
    ABILITY_AURORA_GUARDIAN = 395,
    ABILITY_PRIMORDIAL_RESURGE = 396,
    ABILITY_VERDANT_GUARDIAN = 397,
    ABILITY_SAND_SCOURGE = 398,
    ABILITY_RAIN_WARDEN = 399,
