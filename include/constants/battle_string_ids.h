...
enum StringID
{
    ...
    STRINGID_RAINWARDENACTIVATES,
    STRINGID_VERDANTGUARDIANACTIVATES,
    STRINGID_SANDSCOURGEACTIVATES,
    STRINGID_SNOWPROTOCOLACTIVATES,
    STRINGID_PSYCHOMATRIXACTIVATES,
    STRINGID_ETHEREALDREAMACTIVATES,
    STRINGID_PHANTOMAURAACTIVATES,
    ...
    STRINGID_PKMNRAISEDGHOSTPOWERWITH,
    STRINGID_STIKERENTERS,
    STRINGID_STEALTHROCKDESTROYED,
    STRINGID_ABILITYSHIELDPROTECTS,
    STRINGID_INNATEQUARKDRIVEACTIVATES,
    STRINGID_INNATEPROTOSYNTHESISACTIVATES,
    STRINGID_WEATHERDISAPPEARS,
    STRINGID_COUNT
};
