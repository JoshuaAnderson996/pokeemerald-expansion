...
static const u8 gText_YouThrowABallNowRight[] = _("You throw a BALL now, right?\nI… I'll do my best!");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNRAISEDGHOSTPOWERWITH]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} raised the power of Ghost-type moves!"),
    ...
    [STRINGID_FOGWEATHERSTARTS]                     = COMPOUND_STRING("A thick fog enveloped the battlefield!"),
    [STRINGID_TARGETELECTRIFIED]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s moves have been electrified!"),
    [STRINGID_MEGAEVOREACTING]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ITEM} is reacting to {B_ATK_TRAINER_NAME}'s Bond!"), //actually displays the type of mega ring in inventory, but we didnt implement them :(
    ...
    [STRINGID_RAINWARDENACTIVATES]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Rain Warden activated!"),
    ...
    [STRINGID_VERDANTGUARDIANACTIVATES]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Verdant Guardian activated!"),
    [STRINGID_SANDSCOURGEACTIVATES]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Sand Scourge activated!"),
    [STRINGID_SNOWPROTOCOLACTIVATES]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Snow Protocol activated!"),
    [STRINGID_PSYCHOMATRIXACTIVATES]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Psycho Matrix activated!"),
    [STRINGID_ETHEREALDREAMACTIVATES]               = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Ethereal Dream activated!"),
    [STRINGID_PHANTOMAURAACTIVATES]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Phantom Aura activated!"),
    [STRINGID_INNATEQUARKDRIVEACTIVATES]            = COMPOUND_STRING("The {B_SCR_NAME_WITH_PREFIX2}'s power surged!"),
    [STRINGID_INNATEPROTOSYNTHESISACTIVATES]        = COMPOUND_STRING("The {B_SCR_NAME_WITH_PREFIX2}'s power surged!"),
    ...
    [STRINGID_PKMNHURTBYVINES]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by ferocious vines!"),
    [STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{B_DEF_TEAM1} Pokémon got caught in a vortex of water!"),
    [STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by a vortex!"),
    [STRINGID_TEAMSURROUNDEDBYFIRE]                 = COMPOUND_STRING("{B_DEF_TEAM1} Pokémon were surrounded by fire!"),
    [STRINGID_PKMNBURNINGUP]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is burning up in flames!"),
    [STRINGID_TEAMSURROUNDEDBYROCKS]                = COMPOUND_STRING("{B_DEF_TEAM1} Pokémon became surrounded by rocks!"),
    [STRINGID_PKMNHURTBYROCKSTHROWN]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by rocks!"),
    ...
    [STRINGID_WEATHERDISAPPEARS]                     = COMPOUND_STRING("The weather disappeared due to {B_SCR_NAME_WITH_PREFIX2}'s {B_SCR_ABILITY}!"),
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_STRIKER ] = STRINGID_STIKERENTERS,
};
...
const u16 gExorcistStringIds[] =
{
    [B_MSG_EXORCIST_BOOST]    = STRINGID_PKMNRAISEDGHOSTPOWERWITH,
    [B_MSG_FLASH_FIRE_NO_BOOST] = STRINGID_PKMNSXMADEYINEFFECTIVE
};
