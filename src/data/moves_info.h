...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .effect = EFFECT_MULTI_HIT,
        .power = 25,
        .type = TYPE_COSMIC, //Make Cosmic TYPE
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_RAZOR_WIND] =
    {
        ...
        .description = COMPOUND_STRING(
            "A sharp wind move that strikes\n"
            "the foe."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FLYING,
    ...
    [MOVE_VINE_WHIP] =
    {
        ...
        #endif
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 40 : 35,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .target = MOVE_TARGET_SELECTED,
        .priority = 1,
    ...
    [MOVE_SURF] =
    {
        ...
        .description = COMPOUND_STRING(
        "Summons a massive wave that\n"
        "washes away hazards before\n"
    ...
    [MOVE_SPIRIT_SWORD] =
    {
        .name = COMPOUND_STRING("Spirit Sword"),
        .description = COMPOUND_STRING(
            "Slashes with claws, etc. Has\n"
            "a high critical-hit ratio."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_AURA_DRAIN] =
    {
        .name = COMPOUND_STRING("Aura Drain"),
        .description = COMPOUND_STRING(
            "An attack that steals half\n"
            "the damage inflicted."),
        .effect = EFFECT_ABSORB,
    ...
    [MOVE_ROCK_SMASH] =
    {
        ...
        .description = COMPOUND_STRING(
        "A rock-crushing strike that\n"
        "shatters field hazards and\n"
    ...
    [MOVE_GLITTER_BOMB] =
    {
        .name = COMPOUND_STRING("Glitter Bomb"),
        .description = COMPOUND_STRING( 
    ...
    {
        .name = COMPOUND_STRING("Righteous Strike"),
        .description = COMPOUND_STRING(
            "An attack that does more\n"
            "damage if an ally fainted."),
        .effect = EFFECT_RETALIATE,
    ...
    [MOVE_BOUNCY_BUBBLE] =
    {
        ...
        #endif
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 70 : 70,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_SPIN_OUT] =
    {
       ...
       .description = COMPOUND_STRING(
        "Furiously stomps the ground,\n"
        "clearing hazards but harshly\n"
        "lowering the user's Speed."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_BEFUDDLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A Magical dust power\n"
            "that can cause a series\n"
            "of effects"),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = 60,
        .type = TYPE_BUG,
    ...
    {
        .name = COMPOUND_STRING("Hurricane"),
        .description = COMPOUND_STRING("Hits foe with a powerful storm"),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = 80,
        .type = TYPE_WATER,
        .accuracy = 70,
    ...
    [MOVE_PHEROMONE_WAVE] = 
    {
        .name = COMPOUND_STRING("Pheromone Wave"),
        .description = COMPOUND_STRING("Cause infatuation and may poison."),
        .effect = EFFECT_ATTRACT,
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_GARBAGE_TOSS] =
    {
        .name = COMPOUND_STRING("Garbage Toss"),
        .description = COMPOUND_STRING(
            "The user throws trash that hit one\n"
            "to ten times in a row."),
        .effect = EFFECT_POPULATION_BOMB,
        .power = 20,
        .type = TYPE_POISON,
    ...
    [MOVE_BUG_BLITZ] =
    {
        .name = COMPOUND_STRING("Bug Blitz"),
        .description = COMPOUND_STRING(
            "Repeatedly punches the foe\n"
            "2 to 5 times."),
        .effect = EFFECT_MULTI_HIT,
    ...
    [MOVE_RICHTER_FIST] =
    {
        .name = COMPOUND_STRING("Richter Fist"),
        .description = COMPOUND_STRING(
            "Does more damage every turn\n"
            "it is used."),
        .effect = EFFECT_ECHOED_VOICE,
    ...
    [MOVE_STONE_FIST] =
    {
        .name = COMPOUND_STRING("Stone Fist"),
        .description = COMPOUND_STRING(
            "Hits a foe May raise Defense."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_PSYCHIC,
        .accuracy = 90,
    ...
    [MOVE_CLEANSE_EVIL] =
    {
        .name = COMPOUND_STRING("Cleanse Evil"),
        .description = COMPOUND_STRING("Destroys the evil."),
        .effect = EFFECT_SUPER_EFFECTIVE_ON_ARG,
        .power = 70,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    [MOVE_HUNTING_SLASH] =
    {
        .name = COMPOUND_STRING("Hunting Flash"),
        .description = COMPOUND_STRING(
            "Does double damage if the\n"
            "foe is poisoned."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
    ...
    [MOVE_SOLAR_CRASH] =
    {
        .name = COMPOUND_STRING("Solar Crash"),
        .description = COMPOUND_STRING(
            "Crashes into the \n"
            "foe Cosmic/Fire"),
        .effect = EFFECT_TWO_TYPED_MOVE,
    ...
    [MOVE_LUNAR_WRATH] =
    {
        .name = COMPOUND_STRING("Lunar Wrath"),
        .description = COMPOUND_STRING(
            "Blasts the \n"
            "foe Cosmic/Psychic"),
        .effect = EFFECT_TWO_TYPED_MOVE,
    ...
    [MOVE_SLICE_N_DICE] =
    {
        .name = COMPOUND_STRING("Slice & Dice"),
        .description = COMPOUND_STRING(
            "Attacks with brutal hits\n"
            "that strike twice."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SEASONING_STORM] =
    {
        .name = COMPOUND_STRING("Seasoning Storm"),
        .description = COMPOUND_STRING(
            "Strikes with seasoning.\n"
            "May raise Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_GRASS,
    ...
    [MOVE_FLAMBE_FURRY] =
    {
        .name = COMPOUND_STRING("Flambé Fury"),
        .description = COMPOUND_STRING(
            "Burns up Berries and Gems\n"
            "preventing their use."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_BOIL_OVER] =
    {
        ...
        .description = COMPOUND_STRING("Heats up water."),
        .effect = EFFECT_SUPER_EFFECTIVE_ON_ARG,
        .power = 70,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_PLATE_THROW] =
    {
        .name = COMPOUND_STRING("Plate Throw"),
        .description = COMPOUND_STRING(
            "Throw plates, Type depends of plate."),
        .effect = EFFECT_CHANGE_TYPE_ON_ITEM,
        .power = 75,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_HERO_BLAST] =
    {
        .name = COMPOUND_STRING("Hero Blast"),
        .description = COMPOUND_STRING(
            "An empowered blast.\n"
            "May raise Sp. Atk."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_MELTING_POINT] =
    {
        .name = COMPOUND_STRING("Melting Point"),
        .description = COMPOUND_STRING(
            "Blazing heat.\n"
            "Strong against Rock types."),
        .effect = EFFECT_SUPER_EFFECTIVE_ON_ARG,
        .power = 70,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_POWER_WASH] =
    {
        .name = COMPOUND_STRING("Power Wash"),
        .description = COMPOUND_STRING(
            "Strikes with pressurized water.\n"
    ...
    [MOVE_SHORT_CIRCUIT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Disrupts with electric.\n"
            "Strong against Electric types."),
        .effect = EFFECT_SUPER_EFFECTIVE_ON_ARG,
        .power = 70,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_FAE_HUNTER] =
    {
        .name = COMPOUND_STRING("Fae Hunter"),
        .description = COMPOUND_STRING(
            "Destroys fairies.\n"
            "Strong against Fairy types."),
        .effect = EFFECT_SUPER_EFFECTIVE_ON_ARG,
        .power = 70,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_BERG_CRASH] =
    {
        .name = COMPOUND_STRING("Berg Crash"),
        .description = COMPOUND_STRING(
            "Fires a beam of steel from\n"
            "its body. It hurts the user."),
        .effect = EFFECT_MAX_HP_50_RECOIL,
    ...
    [MOVE_FROST_HORN] =
    {
        .name = COMPOUND_STRING("Frost Horn"),
        .description = COMPOUND_STRING(
            "Frost empowered horn attack\n"
            "may cause freeze/frostbite."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_ICE,
        .accuracy = 100,
    ...
    [MOVE_SLIP_SLIDE] =
    {
        .name = COMPOUND_STRING("Slip Slide"),
        .description = COMPOUND_STRING(
            "Hits with light, frosty\n"
            "steps. Ups the user's Speed."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_ICE,
    ...
    [MOVE_DART_SHOT] =
    {
        .name = COMPOUND_STRING("Dart Shot"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
    ...
    {
        .name = COMPOUND_STRING("Voltage Barrage"),
        .description = COMPOUND_STRING(
            "A Shocking Spin attack that gets\n"
            "more powerful with each hit."),
        .effect = EFFECT_TRIPLE_KICK,
        .power = 20,
        .type = TYPE_ELECTRIC,
