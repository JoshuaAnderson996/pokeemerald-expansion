...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_EDIT_ABILITY]    = {COMPOUND_STRING("Switch Ability"),  CursorCb_EditAbility},
...
static const u8 sPartyMenuAction_EditAbility[] = { MENU_EDIT_ABILITY, MENU_CANCEL1 };
...
static const u8 *const sPartyMenuActions[] =
{
    ...
    [ACTIONS_EDIT_ABILITY]   = sPartyMenuAction_EditAbility,
};
...
static const u8 sPartyMenuActionCounts[] =
{
    ...
    [ACTIONS_EDIT_ABILITY]   = ARRAY_COUNT(sPartyMenuAction_EditAbility),
};
