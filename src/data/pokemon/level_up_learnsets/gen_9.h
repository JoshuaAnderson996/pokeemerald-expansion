...
static const struct LevelUpMove sPikachuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(35, MOVE_FINSHING_SLAM),  
...
static const struct LevelUpMove sClefableLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_ICE_BEAM),        // solid special coverage
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_WAVE),   // spread paralysis
    LEVEL_UP_MOVE( 1, MOVE_NASTY_PLOT),     // boost SpA for a sweep
    LEVEL_UP_MOVE( 1, MOVE_PROTECT),        // stall/pivot
    LEVEL_UP_MOVE( 1, MOVE_HEAL_BELL),      // team heal
...
static const struct LevelUpMove sCrobatLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(50, MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(55, MOVE_LEECH_LIFE),
    LEVEL_UP_MOVE(60, MOVE_BRAVE_BIRD),     // Powerful late-game Flying move
    LEVEL_UP_MOVE(65, MOVE_TOXIC_SPIKES),   // Useful hazard
    LEVEL_UP_MOVE(73, MOVE_GALE_FORCE),     // New move added
    LEVEL_UP_END
};
#endif //P_GEN_2_CROSS_EVOS
