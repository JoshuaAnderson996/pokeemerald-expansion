...
#if P_FAMILY_ESPURR
static const u16 sMeowsticMegaFormSpeciesIdTable[] = {
...
#if _FAMILY_FRIGIBAX
static const u16 sArctibaxFormSpeciesIdTable[] = {
    SPECIES_BAXCALIBUR,
#if P_MEGA_EVOLUTIONS
