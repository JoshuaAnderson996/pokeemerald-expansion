...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_FURRET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SCRAPPY, ABILITY_EXPLORER, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 105 : 75)
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_QUICK_TEMPERED, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_POISON_SPECIALIST, ABILITY_SAND_FORCE, ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_PURPLE,
