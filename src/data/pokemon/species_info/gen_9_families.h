...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_BRAMBLEGHAST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_WIND_RIDER, ABILITY_WIND_POWER, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HOUNDSTONE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_SPEED_BOOST, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SINISTCHA_UNREMARKABLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_HOSPITALITY, ABILITY_SHADOW_SHIELD, ABILITY_HEATPROOF },
        .bodyColor = BODY_COLOR_GREEN,
