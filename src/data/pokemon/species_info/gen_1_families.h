...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_HUGE_POWER, ABILITY_COMPETITIVE, ABILITY_CONCERT },
    #else
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 105 : 80)
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SNIPER, ABILITY_TECHNICIAN, ABILITY_MEGA_MIND },
    #else
...
#define GENGAR_ABILITIES {ABILITY_CURSED_BODY, ABILITY_NONE, ABILITY_INFILTRATOR}
#else
#define GENGAR_ABILITIES {ABILITY_INFILTRATOR, ABILITY_NONE, ABILITY_NONE}
#endif
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_STARMIE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_REGENERATOR, ABILITY_NEUROFORCE },
        .bodyColor = BODY_COLOR_PURPLE,
