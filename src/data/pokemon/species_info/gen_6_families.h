...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_GOGOAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GRASS_PELT, ABILITY_WEATHER_WARRIOR, ABILITY_STAMINA },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_TREVENANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_GRASSY_SURGE, ABILITY_CURSED_BODY, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GOURGEIST_AVERAGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PICKUP, ABILITY_FRISK, ABILITY_COMATOSE },
        .bodyColor = BODY_COLOR_BROWN,
