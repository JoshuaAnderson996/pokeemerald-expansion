...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_KLINKLANG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_TRANSISTOR, ABILITY_NONE, ABILITY_STEELY_SPIRIT },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_HYDREIGON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_PARENTAL_BOND, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MELOETTA_ARIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_CONCERT, ABILITY_DANCER },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
