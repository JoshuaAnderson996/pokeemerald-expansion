...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_KLINKLANG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_GALVANIZE, ABILITY_STEELY_SPIRIT, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_ICE_SCALES, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_HYDREIGON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_LEVITATE, ABILITY_PARENTAL_BOND, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_BLUE,
