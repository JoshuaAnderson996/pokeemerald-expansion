...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_ZOROARK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ILLUSION, ABILITY_NONE, ABILITY_QUICK_TEMPERED },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CHANDELURE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_DROUGHT, ABILITY_SHADOW_TAG, ABILITY_INFILTRATOR },
    #else
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_FLAME_BODY, ABILITY_SHADOW_TAG },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_ACCELGOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHINOBI, ABILITY_STICKY_HOLD, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MANDIBUZZ] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FLUFFY, ABILITY_OVERCOAT, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_BROWN,
