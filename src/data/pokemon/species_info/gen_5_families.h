...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_VICTINI] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_HERO, TYPE_FIRE),
        .catchRate = 3,
    ...
    [SPECIES_SERPERIOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_VERDANT_GUARDIAN, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TEPIG] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_BLAZE, ABILITY_SHEER_FORCE },
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        {EVO_LEVEL, 36, SPECIES_SAMUROTT_HISUI, CONDITIONS({ IF_KNOWS_MOVE, MOVE_CEASELESS_EDGE })},
    ...
    [SPECIES_SAMUROTT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TORRENT, ABILITY_WEAK_ARMOR, ABILITY_BLADE_DANCER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SAMUROTT_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TORRENT, ABILITY_RAIN_WARDEN, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Samurott"),
        .cryId = CRY_SAMUROTT,
        .natDexNum = NATIONAL_DEX_SAMUROTT,
    ...
    [SPECIES_WATCHOG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FUR_COAT, ABILITY_KEEN_EYE, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_STOUTLAND] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_HERO),
        .catchRate = 45,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ADAPTABILITY, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LIEPARD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_UNBURDEN, ABILITY_OPPORTUNIST },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SIMISEAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GLUTTONY, ABILITY_SOLAR_POWER, ABILITY_BLAZE },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_SIMIPOUR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CHEF, ABILITY_DRIZZLE, ABILITY_TORRENT },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MUSHARNA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PSYCHIC_SURGE, ABILITY_CLOUD_NINE, ABILITY_KINETIC_BARRIER },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SWOOBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FLYING),
        .abilities = { ABILITY_UNAWARE, ABILITY_SIMPLE, ABILITY_CUTE_CHARM },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_AUDINO] =
    {
        ...
        .abilities = { ABILITY_HEALER, ABILITY_REGENERATOR, ABILITY_MISTY_SURGE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SEISMITOAD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_POISON_SPECIALIST, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_THROH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_GUTS, ABILITY_STAMINA, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Throh"),
        .cryId = CRY_THROH,
    ...
    [SPECIES_SAWK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_STURDY, ABILITY_SCRAPPY, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        .speciesName = _("Sawk"),
        .cryId = CRY_SAWK,
    ...
    [SPECIES_LEAVANNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_CHLOROPHYLL, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_WHIMSICOTT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_PRANKSTER, ABILITY_SOLAR_POWER, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_LILLIGANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_DANCER, ABILITY_VERDANT_GUARDIAN },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_LILLIGANT_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_DANCER, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Lilligant"),
        .cryId = CRY_LILLIGANT,
    ...
    [SPECIES_BASCULEGION_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_HAZE_STEP, ABILITY_ADAPTABILITY, ABILITY_PHANTOM_AURA },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_BASCULEGION_F] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_ADAPTABILITY, ABILITY_RAIN_WARDEN },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Basculegion"),
        .cryId = CRY_BASCULEGION,
        .natDexNum = NATIONAL_DEX_BASCULEGION,
    ...
    [SPECIES_MARACTUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_EARTH_EATER, ABILITY_SOLAR_POWER, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CRUSTLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STURDY, ABILITY_ROCKY_PAYLOAD, ABILITY_ANGER_SHELL },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SCRAFTY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_RUFFIAN, ABILITY_MOXIE, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_COFAGRIGUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MUMMY, ABILITY_MUMMY, ABILITY_PHANTOM_AURA },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_RUNERIGUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_WANDERING_SPIRIT, ABILITY_FOG_CALLING },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CARRACOSTA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_ANGER_SHELL, ABILITY_STURDY, ABILITY_RAIN_WARDEN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GARBODOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STENCH, ABILITY_TOUGH_CLAWS, ABILITY_TOXIC_DEBRIS },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_ZOROARK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ILLUSION, ABILITY_QUICK_TEMPERED, ABILITY_PHANTOM_AURA },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ZOROARK_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ILLUSION, ABILITY_QUICK_TEMPERED, ABILITY_FOG_CALLING },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Zoroark"),
        .cryId = CRY_ZOROARK,
        .natDexNum = NATIONAL_DEX_ZOROARK,
    ...
    [SPECIES_GOTHITELLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_PSYCHO_MATRIX, ABILITY_COMPETITIVE, ABILITY_SHADOW_TAG },
    #else
        .abilities = { ABILITY_FRISK, ABILITY_NONE, ABILITY_SHADOW_TAG },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SWANNA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FLYING),
        .abilities = { ABILITY_GALE_WINGS, ABILITY_BIG_PECKS, ABILITY_RAIN_WARDEN },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SAWSBUCK_SPRING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_REGENERATOR, ABILITY_WEATHER_WARRIOR, ABILITY_CHLOROPHYLL },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SAWSBUCK_SUMMER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SOLAR_PRAYER, ABILITY_WEATHER_WARRIOR, ABILITY_CHLOROPHYLL },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Sawsbuck"),
        .cryId = CRY_SAWSBUCK,
        .natDexNum = NATIONAL_DEX_SAWSBUCK,
    ...
    [SPECIES_SAWSBUCK_AUTUMN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNBURDEN, ABILITY_WEATHER_WARRIOR, ABILITY_CHLOROPHYLL },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Sawsbuck"),
        .cryId = CRY_SAWSBUCK,
        .natDexNum = NATIONAL_DEX_SAWSBUCK,
    ...
    [SPECIES_SAWSBUCK_WINTER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_REFRIGERATE, ABILITY_WEATHER_WARRIOR, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Sawsbuck"),
        .cryId = CRY_SAWSBUCK,
        .natDexNum = NATIONAL_DEX_SAWSBUCK,
    ...
    [SPECIES_ESCAVALIER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SHELL_ARMOR, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_AMOONGUSS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_VERDANT_GUARDIAN, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_JELLICENT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_REGENERATOR, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_ALOMOMOLA] =
    {
        ...
        .abilities = { ABILITY_MEDIC, ABILITY_HYDRATION, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_GALVANTULA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_UNNERVE, ABILITY_SWARM },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_FERROTHORN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_IRON_BARBS, ABILITY_VERDANT_GUARDIAN, ABILITY_ANTICIPATION },
    #else
        .abilities = { ABILITY_IRON_BARBS, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_KLINKLANG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_GALVANIZE, ABILITY_STEELY_SPIRIT, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_EELEKTROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_SHEER_FORCE, ABILITY_ELECTRIC_SURGE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BEHEEYEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_TELEPATHY, ABILITY_KINETIC_BARRIER, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CHANDELURE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_FOG_CALLING, ABILITY_SHADOW_TAG, ABILITY_INFILTRATOR },
    #else
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_FLAME_BODY, ABILITY_SHADOW_TAG },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CHANDELURE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_FOG_CALLING, ABILITY_FOG_CALLING, ABILITY_FOG_CALLING },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Chandelure"),
        .cryId = CRY_CHANDELURE,
        .natDexNum = NATIONAL_DEX_CHANDELURE,
    ...
    [SPECIES_HAXORUS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_UNNERVE, ABILITY_MOLD_BREAKER, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_ICE_SCALES, ABILITY_ICE_SCALES, ABILITY_SNOW_PROTOCOL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ACCELGOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHINOBI, ABILITY_PHANTOM_AURA, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_STUNFISK_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MIMICRY, ABILITY_NO_ESCAPE, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Stunfisk"),
        .cryId = CRY_STUNFISK,
        .natDexNum = NATIONAL_DEX_STUNFISK,
    ...
    [SPECIES_MIENSHAO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PSYCHO_MATRIX, ABILITY_REGENERATOR, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DRUDDIGON] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_SHEER_FORCE, ABILITY_DRAGONS_PRIDE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_DEFIANT, ABILITY_PRESSURE, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_KINGAMBIT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_DEFIANT, ABILITY_SUPREME_OVERLORD, ABILITY_BLADE_DANCER},
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_BOUFFALANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RECKLESS, ABILITY_FUR_COAT, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_BRAVIARY] =
    {
        ...
        .baseSpAttack  = 37,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_HERO, TYPE_FLYING),
        .catchRate = 60,
        .expYield = 179,
        .evYield_Attack = 2,
        .genderRatio = MON_MALE,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_HEROICS, ABILITY_SHEER_FORCE, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MANDIBUZZ] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FLUFFY, ABILITY_OVERCOAT, ABILITY_FOG_CALLING },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HEATMOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_FLASH_FIRE, ABILITY_EVAPORATE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DURANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_HUSTLE, ABILITY_AMOURED_SHELL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_HYDREIGON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_RUFFIAN, ABILITY_PARENTAL_BOND, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_VOLCARONA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_CLOUD_NINE, ABILITY_PROTOSYNTHESIS },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_COBALION] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 72,
        .types = MON_TYPES(TYPE_STEEL, TYPE_HERO),
        .catchRate = 3,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_STAMINA, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_TERRAKION] =
    {
        ...
        .baseSpAttack  = 72,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_ROCK, TYPE_HERO),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 290 : 261,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_ANGER_POINT, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_VIRIZION] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 149,
        .types = MON_TYPES(TYPE_GRASS, TYPE_HERO),
        .catchRate = 3,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 290 : 261,
        .evYield_SpDefense = 3,
        .genderRatio = MON_GENDERLESS,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_VERDANT_GUARDIAN, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_THUNDURUS_THERIAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_VOLT_ABSORB, ABILITY_TRANSISTOR },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Thundurus"),
    ...
    [SPECIES_KELDEO_ORDINARY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_JUSTIFIED, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MELOETTA_ARIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_ADAPTABILITY, ABILITY_SINGER },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
...
#define GENESECT_SPECIES_INFO(form)                                                 \
    {                                                                               \
        ...
        .growthRate = GROWTH_SLOW,                                                  \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                  \
        .abilities = { ABILITY_DOWNLOAD, ABILITY_PROTEAN, ABILITY_TINTED_LENS },       \
        .bodyColor = BODY_COLOR_PURPLE,                                             \
