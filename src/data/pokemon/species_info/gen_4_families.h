...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .abilities = { ABILITY_NONE, ABILITY_HEATPROOF, ABILITY_HEAVY_METAL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ROTOM_WASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WATER_BUBBLE, ABILITY_NONE, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
    ...
    [SPECIES_ROTOM_FAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_NONE, ABILITY_WIND_RIDER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
        .natDexNum = NATIONAL_DEX_ROTOM,
