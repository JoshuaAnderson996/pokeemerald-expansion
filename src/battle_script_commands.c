...
static void Cmd_attackcanceler(void)
{
    ...
    if (gSpecialStatuses[gBattlerAttacker].parentalBondState == PARENTAL_BOND_OFF
     && (ctx.abilities[ctx.battlerAtk] == ABILITY_PARENTAL_BOND || GetBattlerAbility(gBattlerAttacker) == ABILITY_MOTHERS_BOND || GetBattlerAbility(gBattlerAttacker) == ABILITY_TIDAL_TERROR)
